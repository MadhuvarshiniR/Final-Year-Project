...
def store_text(text):
    ...
    # Displaying the image
        cv2.putText(image, l.upper(), (20,180), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 2)
...
button = Button(app, text='TRANSLATE',width=29,command=store_text,font=("Comic Sans Ms",14))
